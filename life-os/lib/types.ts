...
export interface IncomeSource {
  ...
  frequency: Frequency;
  is_active: boolean;
  next_expected_date: Nullable<ISODate>;
...
export type BudgetItemUpdate = Partial<BudgetItemInsert>;
...
export type MonthlySnapshotUpdate =
  Partial<Omit<MonthlySnapshotInsert, "month">>;
...
export interface InvestmentAsset {
  ...
  monthly_contribution_target: Nullable<number>;
  target_quantity: Nullable<number>;
  is_active: boolean;
  notes: Nullable<string>;
  created_at: ISODateTime;
  updated_at: ISODateTime;
...
export type InvestmentTransactionUpdate =
  Partial<InvestmentTransactionInsert>;
...
export interface LearningItem {
  ...
  start_date: Nullable<ISODate>;
  target_date: Nullable<ISODate>;
  completed_date: Nullable<ISODate>;
  url: Nullable<string>;
...
export type MemoryItemUpdate = Partial<MemoryItemInsert>;
...
export interface AIRecommendation {
  ...
  related_entity_type: Nullable<AIRecommendationEntityType>;
  related_entity_id: Nullable<UUID>;
  reviewed_at: Nullable<ISODateTime>;
  created_at: ISODateTime;
  updated_at: ISODateTime;
}
...
export type AIRecommendationUpdate =
  Partial<AIRecommendationInsert>;
...
export interface FinanceSnapshot {
  ...
  latest_monthly_snapshot: Nullable<MonthlySnapshot>;
}


/* =========================================================
 * 19. INVESTMENT CALCULATION TYPES
 * ======================================================= */
...
export interface InvestmentPosition {
  ...
  estimated_gain_loss: Nullable<number>;

  estimated_gain_loss_percent: Nullable<number>;

  allocation_percent: Nullable<number>;

  target_progress_percent: Nullable<number>;
}
...
export interface InvestmentSnapshot {
  ...
  total_estimated_gain_loss: number;

  total_monthly_contribution_target: number;
...
export interface GoalStatusSnapshot {
  ...
  high_priority_goals: GoalSummary[];
  active_goals: GoalSummary[];
}


/* =========================================================
 * 21. PROJECT SUMMARY TYPES
 * ======================================================= */
...
export interface ProjectStatusSnapshot {
  ...
  planned_count: number;
  completed_count: number;
  high_priority_projects: ProjectSummary[];
  blocked_projects: ProjectSummary[];
}


/* =========================================================
 * 22. TASK SUMMARY TYPES
 * ======================================================= */
...
export interface TaskStatusSnapshot {
  ...
  urgent_tasks: TaskSummary[];
}


/* =========================================================
 * 23. LEARNING SUMMARY TYPES
 * ======================================================= */
...
export interface LearningStatusSnapshot {
  ...
  completed_count: number;
  paused_count: number;
  active_items: LearningSummary[];
  high_priority_items: LearningSummary[];
}


/* =========================================================
 * 24. CAREER SUMMARY TYPES
 * ======================================================= */

export interface CareerSnapshot {
  current_roles: CareerItem[];
  target_roles: CareerItem[];
  skills: CareerItem[];
  achievements: CareerItem[];
  milestones: CareerItem[];
  gaps: CareerItem[];
}


/* =========================================================
 * 25. PRIORITY ENGINE TYPES
 * ======================================================= */
...
export interface DashboardSnapshot {
  ...
  goals: GoalStatusSnapshot;

  projects: ProjectStatusSnapshot;

  tasks: TaskStatusSnapshot;

  learning: LearningStatusSnapshot;

  latest_ai_recommendation: Nullable<AIRecommendation>;
}
...
export interface PersonalContext {
  ...
  relevant_learning: LearningItem[];

  relevant_career: CareerItem[];
...
export interface AIToolResult<TData = JsonValue> {
  tool: AIToolName;
  success: boolean;
  data: Nullable<TData>;
...
export interface DecisionSimulationInput {
  ...
  proposed_monthly_cost?: Nullable<number>;

  proposed_one_time_cost?: Nullable<number>;

  proposed_monthly_investment_change?: Nullable<number>;

  proposed_start_date?: Nullable<ISODate>;

  proposed_target_date?: Nullable<ISODate>;
...
export interface DecisionScenario {
  ...
  title: string;
  summary: string;
  affordability: Nullable<boolean>;
  monthly_available_after: Nullable<number>;
...
export interface DecisionSimulationResult {
  ...
  recommended_scenario_id: Nullable<string>;

  main_tradeoff: Nullable<string>;
...
export interface OpportunitySearchResult {
  ...
  searched_at: ISODateTime;
}


/* =========================================================
 * 34. DATA TABLE UI TYPES
 * ======================================================= */
...
/* =========================================================
 * 37. OPERATION RESULTS
 * ======================================================= */

export type OperationResult<TData = undefined> =
  | {
      success: true;
      data: TData;
    }
...
export interface LifeOSEntityMap {
  ...
  career_items: CareerItem;
  memory_items: MemoryItem;
  ai_recommendations: AIRecommendation;
  audit_logs: AuditLog;
}

export type LifeOSTableName = keyof LifeOSEntityMap;


/* =========================================================
 * 40. MUTABLE ENTITY NAME
 * ======================================================= */

export type MutableLifeOSTableName = Exclude<
  LifeOSTableName,
  "audit_logs"
>;
...
/* =========================================================
 * 41. SECURITY-SENSITIVE ACTION TYPES
 * ======================================================= */
 ...
 * - Insert input never accepts user_id from browser/model input.
