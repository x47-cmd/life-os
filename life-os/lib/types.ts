...
/* =========================================================
 * 4E. TRAVEL STRUCTURED PROPOSAL
 * ======================================================= */

/**
 * Travel proposal contract.
 *
 * Travel is now active at the shared TypeScript proposal
 * boundary because the exact-value review UI exists.
 *
 *
 * Activation still does NOT mean execution.
 *
 *
 ...
 *      ✅
 *
 * Travel validation contract
 *      ✅
 *
 * Universal Add exact-value review
 *      ✅
 *
 * Universal Add confirmation blocking when values are absent
 *      ✅
 *
 *
 * Still required before permanent Travel persistence:
 *
 * active runtime preview validation
 *      ↓
 * AI create_trip output
 *      ↓
 * explicit confirmation
 *      ↓
 ...
 *
 *
 * Type activation does NOT grant database authority.
 */
 ...
 *
 *
 * A TypeScript proposal is NOT execution authority.
 *
 *
 * Every structured proposal remains untrusted until:
 *
 * runtime schema validation
 *      ↓
 * user sees every exact value
 *      ↓
 * explicit approval
 *      ↓
 * deterministic executor
...
export interface IntakePreview {
   ...
   *
   * contains the exact validated structured proposal.
   *
   *
   * document / note:
   *
 ...
 *
 *
 * Structured proposal domains:
 *
 * finance → structured finance proposal
 * plan    → structured plan proposal
 * growth  → structured growth proposal
 * travel  → structured travel proposal
 *
 *
 * Travel is now active at the TypeScript boundary because
 * its exact-value review UI exists.
 *
 *
 * Runtime activation still happens separately.
 *
 * Until strict runtime Travel validation is activated,
 * the preview API may continue returning:
 *
 * travel → null
 *
 *
 ...
 *
 *
 * Type activation alone never authorizes persistence.
 */
